...
- fold durable decisions into `docs/ai/architecture-map.md`,
  `docs/product/phase-backlog.md`, or `docs/product/execution-tracker.md`
- move the brief to `docs/archive/` if historical context is still useful
- delete it if the durable context is already captured elsewhere
